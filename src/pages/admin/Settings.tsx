...
import { EDURO_PRIMARY_BLUE, getEduroAccentColor } from '../../lib/brand';
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    if (isMockSupabase) {
      setSettings({
        ...
        accent_color: getEduroAccentColor(settings.accent_color),
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <Input
                  ...
                  value={settings.accent_color || EDURO_PRIMARY_BLUE}
              ...
              <p className="text-sm text-slate-500">Suositus: Eduro-pääsävy #253b70 yleiseen käyttöön.</p>
            </div>
          </CardContent>
        </Card>
