...
function isVisibleWindowContent(item: { is_published: boolean; start_at: string | null; end_at: string | null }, now: Date) {
              ...
              >
                ...
                >
                  {currentContent.data.subtitle && (
                    <span className="mb-4 text-xl font-semibold uppercase tracking-wider" style={{ color: accentColor }}>
                      {currentContent.data.subtitle}
                    </span>
                  )}
                  ...
                  <div className="flex items-center space-x-6 rounded-2xl border border-slate-800/50 bg-slate-950/50 p-8">
                    ...
                    <div>
                      ...
                      <div className="text-3xl font-semibold">
                        {format(parseEventDate(currentContent.data.event_date), 'd.M.yyyy')}
